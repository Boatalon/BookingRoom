...
public class ManagePage extends JFrame {
 	...
 	private void deleteSelectedRoom() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete room " + roomId + "?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
 	...
 	private void refreshRoomTable() {
        ...
        for (Room room : Room.getRoomList()) {
            roomTableModel.addRow(new Object[]{ room.getRoomId(), room.isAvailable(today, 9, 1) ? "Available" : "Booked"});
        }
    }
